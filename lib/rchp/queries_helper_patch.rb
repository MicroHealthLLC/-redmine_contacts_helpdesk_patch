...
module Rchp
  module QueriesHelperPatch
    def self.included(base)
      ...
      base.class_eval do
        unloadable
        alias_method_chain :column_content, :new_helpdesk
      end
    end
    ...
    module InstanceMethods
      ...
      def column_content_with_new_helpdesk(column, issue)
